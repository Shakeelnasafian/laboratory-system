<div>
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('lab.patients.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white text-sm px-4 py-2 rounded-lg transition">+ New Patient</a>
    </div>
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                    ...
                    <td class="px-6 py-3">
                        <div class="flex gap-2">
                            <a href="{{ route('lab.orders.create') }}?patient={{ $patient->id }}" class="text-blue-600 hover:underline text-xs">+ Order</a>
                            <a href="{{ route('lab.patients.edit', $patient) }}" class="text-gray-600 hover:underline text-xs">Edit</a>
                        </div>
                    </td>
                </tr>
                @empty
